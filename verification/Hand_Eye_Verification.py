...
Data_of_Rotation_and_Encoder = np.load(out_put_save_directory+'/verification/Data_of_Rotation_and_Encoder.npy', allow_pickle=True)
...
R_mat_hand_eye = sf.M33(
    [
        [0.997229, -0.0235576, -0.0705671],
        [0.027858, 0.997774, 0.0605906],
        [0.0689827, -0.0623886, 0.995665],
    ]
)
...
for j in range(1, (len(Data_of_Rotation_and_Encoder)//k)+1):  # j=(1,68)
    for i in range((j-1)*k, j*k):   # for k=30:  i=(0,29)   i=(30,59)  i=(60,89)  ...
        ...
        DeltaRotKin_list.append(DeltaRotKin.subs((alpha, beta, theta11, theta12, theta21, theta22),(0.726492, 0.825976, Data_of_Rotation_and_Encoder[i][3][0], Data_of_Rotation_and_Encoder[i][3][1], Data_of_Rotation_and_Encoder[j][3][0], Data_of_Rotation_and_Encoder[j][3][1])))
